...
public class TestAlgorithms2 {
		...
		public void depthFirstSearchTest() {
			...
			root1.add(v5);
			testTraverses.add(root1);
			assertEquals(true, Algorithms.depthFirstSearch(testGraph1).contains(root1));
			...
			testTraverses.add(root2);
			assertEquals(true, Algorithms.depthFirstSearch(testGraph1).contains(root2));
			...
			System.out.println(Algorithms.depthFirstSearch(testGraph1));
			assertEquals(true,Algorithms.depthFirstSearch(testGraph1).contains(root3));

			List<Vertex> root4 = new ArrayList<Vertex>();
			root4.add(v4);
			testTraverses.add(root4);
			assertEquals(true, Algorithms.depthFirstSearch(testGraph1).contains(root4));

			List<Vertex> root5 = new ArrayList<Vertex>();
			root5.add(v5);
			root5.add(v8);
			testTraverses.add(root5);
			assertEquals(true, Algorithms.depthFirstSearch(testGraph1).contains(root5));

			List<Vertex> root6 = new ArrayList<Vertex>();
			root6.add(v6);
			root6.add(v8);
			testTraverses.add(root6);
			assertEquals(true, Algorithms.depthFirstSearch(testGraph1).contains(root6));

			List<Vertex> root7 = new ArrayList<Vertex>();
			root7.add(v7);
			root7.add(v8);
			testTraverses.add(root7);
			assertEquals(true, Algorithms.depthFirstSearch(testGraph1).contains(root7));

			List<Vertex> root8 = new ArrayList<Vertex>();
			root8.add(v8);
			testTraverses.add(root8);
			assertEquals(true, Algorithms.depthFirstSearch(testGraph1).contains(root8));
			
			System.out.println(testTraverses);
			assertEquals(testTraverses, Algorithms.depthFirstSearch(testGraph1));
